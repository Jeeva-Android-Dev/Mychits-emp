...
import com.mazenet.mani.mounika.Model.AuctionReportModel
...
class ShowAuctionReportList(
    private val itemsList: ArrayList<AuctionReportModel>,
    private val listener: AdapterClickListener
) : RecyclerView.Adapter<ShowAuctionReportList.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.txt_collected.text = itemsList[position].getGroupName()!!
        holder.txt_tobecollected.text = Constants.money_convertor(
            Constants.isEmtytoZero(itemsList[position].getTotalReleaseAmount()!!), false)
    }
