...
import com.mazenet.mani.mounika.Model.BusinessAgentReportModel
import com.mazenet.mani.mounika.R
import com.mazenet.mani.mounika.Utilities.Constants
import java.lang.ref.WeakReference
import java.util.*

class Adapter_businessagentReport(
    private val itemsList: ArrayList<BusinessAgentReportModel>,
    private val listener: AdapterClickListener
) : RecyclerView.Adapter<Adapter_businessagentReport.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.txt_custname.text = itemsList[position].getAgentName()
        holder.txt_collected.text = Constants.money_convertor(
            Constants.isEmtytoZero(itemsList[position].getTotalCommissionAmount()!!), false)
        holder.txt_tobecollected.text = Constants.money_convertor(
            Constants.isEmtytoZero(itemsList[position].getPaidCommissionAmount()!!), false)
    }
