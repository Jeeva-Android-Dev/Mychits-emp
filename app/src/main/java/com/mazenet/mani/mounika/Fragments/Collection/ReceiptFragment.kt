...
import com.mazenet.mani.mounika.Adapters.AdapterEdittextListener
import com.mazenet.mani.mounika.Adapters.InstallmentsAdapter
import com.mazenet.mani.mounika.Adapters.ReceiptAdapter
...
import com.mazenet.mani.mounika.Spinners.BankListSpinnerdilog
import com.mazenet.mani.mounika.Spinners.OnSpinnerItemClick
import com.mazenet.mani.mounika.Spinners.PaymentTypeSpinnerdilog
import com.mazenet.mani.mounika.Utilities.BaseUtils
import com.mazenet.mani.mounika.Utilities.BaseUtils.CurrentDate_ymd
...
class ReceiptFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        val view: View
        view = inflater.inflate(com.mazenet.mani.mounika.R.layout.fragment_receipt, container, false)
...
//                masterdb.getInstallmentDetails(enrolid)
    ...
    fun changevalueDilog(item: String, position: Int, oldvalue: String) {
        ...
        val dialogView = inflater.inflate(com.mazenet.mani.mounika.R.layout.change_value_dilog, null)
        dialogBuilder.setView(dialogView)
        val txt_cv_heading =
            dialogView.findViewById(com.mazenet.mani.mounika.R.id.txt_cv_heading) as TextView
        val edt_cv_value =
            dialogView.findViewById(com.mazenet.mani.mounika.R.id.edt_cv_value) as EditText
        dialogBuilder
    ...
    override fun onBackPressed(): Boolean {
        var bool = false
        val builder = AlertDialog.Builder(context, com.mazenet.mani.mounika.R.style.MyErrorDialogTheme)
