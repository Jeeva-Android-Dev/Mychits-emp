package com.mazenet.mani.mounika.Utilities.custom_view;
...
public class IndeterminateProgressButton extends MorphingButton {
    ...
    private void init(Context context) {
        mColor1 = ContextCompat.getColor(context, R.color.colorWhite);
        mColor2 = ContextCompat.getColor(context, R.color.colorPrimary);
        mColor3 = ContextCompat.getColor(context, R.color.colorWhite);
        mColor4 = ContextCompat.getColor(context, R.color.colorPrimary);
