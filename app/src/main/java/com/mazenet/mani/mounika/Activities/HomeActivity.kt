...
import com.mazenet.mani.mounika.Alarmreceivers.AlarmReceiver
import com.mazenet.mani.mounika.Alarmreceivers.BigTextIntentService
import com.mazenet.mani.mounika.Alarmreceivers.GlobalNotificationBuilder
import com.mazenet.mani.mounika.Alarmreceivers.NotificationUtil
import com.mazenet.mani.mounika.BuildConfig
import com.mazenet.mani.mounika.Fragments.Add_customer
import com.mazenet.mani.mounika.Fragments.BaseFragment
import com.mazenet.mani.mounika.Fragments.Collection.*
import com.mazenet.mani.mounika.Fragments.Devices.devices
import com.mazenet.mani.mounika.Fragments.Leads.Show_leads
import com.mazenet.mani.mounika.Fragments.Reports.ReportsList
import com.mazenet.mani.mounika.Fragments.Settings.Settings
import com.mazenet.mani.mounika.Fragments.dashboard_fragments.Admin_Dashboard
import com.mazenet.mani.mounika.Fragments.dashboard_fragments.BusinessAgent_Dashboard
import com.mazenet.mani.mounika.Fragments.dashboard_fragments.Collection_dashboard_Fragment
import com.mazenet.mani.mounika.Model.Before_enroll_success_model
import com.mazenet.mani.mounika.Model.InstallmentListModel
import com.mazenet.mani.mounika.Model.Receiptsuccessmodel
import com.mazenet.mani.mounika.Model.successmsgmodel
import com.mazenet.mani.mounika.R
import com.mazenet.mani.mounika.Retrofit.ICallService
import com.mazenet.mani.mounika.Retrofit.RetrofitBuilder
import com.mazenet.mani.mounika.Services.OfflineService
import com.mazenet.mani.mounika.Utilities.BaseActivity
import com.mazenet.mani.mounika.Utilities.BaseUtils
import com.mazenet.mani.mounika.Utilities.BaseUtils.offlinedb
import com.mazenet.mani.mounika.Utilities.Constants
import com.mazenet.mani.mounika.Utilities.Roles
...
class HomeActivity() : BaseActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    fun replacefragment(fragment: BaseFragment) {
        ...
        transaction.replace(com.mazenet.mani.mounika.R.id.frame_container, fragment)
...
//    private var alarmManager: AlarmManager? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.mazenet.mani.mounika.R.layout.activity_home)
        setSupportActionBar(toolbar)
        check_attendence()
        d("dbtesthome",Constants.db)
        mNotificationManagerCompat = NotificationManagerCompat.from(getApplicationContext());
        supportActionBar!!.setTitle(com.mazenet.mani.mounika.R.string.app_name)
...
//        )
        ...
        navigationView =
            findViewById(com.mazenet.mani.mounika.R.id.nav_view) as NavigationView
        val toggle = ActionBarDrawerToggle(
            this, drawer_layout, toolbar,
            com.mazenet.mani.mounika.R.string.navigation_drawer_open,
            com.mazenet.mani.mounika.R.string.navigation_drawer_close
        )
        ...
        nav_menu.clear()
        navigationView.inflateMenu(com.mazenet.mani.mounika.R.menu.admin_drawer)
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        menuInflater.inflate(com.mazenet.mani.mounika.R.menu.home, menu)
        return true
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            com.mazenet.mani.mounika.R.id.menu_notification -> {
//                openNotificationSettingsForApp()
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            com.mazenet.mani.mounika.R.id.nav_dashboard -> {

                ShowDashboard()
            }


            com.mazenet.mani.mounika.R.id.nav_collection -> {
                replacefragment(Collections())
//                supportFragmentManager.inTransaction {
//                    replace(R.id.frame_container, Collections())
//                }
            }
            com.mazenet.mani.mounika.R.id.nav_add_customer -> {
                replacefragment(Add_customer())
//                supportFragmentManager.inTransaction {
//                    replace(R.id.frame_container, Collections())
//                }
            }
            com.mazenet.mani.mounika.R.id.nav_devices -> {
                replacefragment(devices())
//                supportFragmentManager.inTransaction {
//                    replace(R.id.frame_container, devices())
//                }
            }
            com.mazenet.mani.mounika.R.id.nav_leads -> {
                replacefragment(Show_leads())
//                supportFragmentManager.inTransaction {
//                    replace(R.id.frame_container, Show_leads())
//                }
            }
            com.mazenet.mani.mounika.R.id.nav_reports -> {
                replacefragment(ReportsList())
//                supportFragmentManager.inTransaction {
//                    replace(R.id.frame_container, CominSoon())
//                }
            }
            com.mazenet.mani.mounika.R.id.nav_settings -> {
                replacefragment(Settings())
//                supportFragmentManager.inTransaction {
//                    replace(R.id.frame_container, Settings())
//                }
            }
            com.mazenet.mani.mounika.R.id.nav_logout -> {
                logout()
            }
    ...
    fun finishscreen() {
        val builder = AlertDialog.Builder(
            this@HomeActivity,
            com.mazenet.mani.mounika.R.style.MyErrorDialogTheme
        )
...
//        alarmManager!!.cancel(pendingIntent);
    ...
    private fun CustomerAquring() {
        ShowCustommerAquiring = ProgressDialog.show(
            this@HomeActivity,
            resources.getString(com.mazenet.mani.mounika.R.string.buffertitlecust),
            resources.getString(com.mazenet.mani.mounika.R.string.bufferstring),
            true
        )
    }
    ...
    private fun Uploading() {
        ShowReceiptUploading = ProgressDialog.show(
            this@HomeActivity,
            resources.getString(com.mazenet.mani.mounika.R.string.buffer_uploadingl),
            resources.getString(com.mazenet.mani.mounika.R.string.nulls),
            true
        )
    }
    ...
    fun showDialog(Status: Boolean) {
        val builder = AlertDialog.Builder(
            this@HomeActivity,
            com.mazenet.mani.mounika.R.style.MyDialogTheme
        )
        builder.setCancelable(false)
