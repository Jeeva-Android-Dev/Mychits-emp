...
import com.mazenet.mani.mounika.Model.OutstandingReportModel
...
class ShowOutsReportList(
    private val itemsList: ArrayList<OutstandingReportModel>,
    private val listener: AdapterClickListener
) : RecyclerView.Adapter<ShowOutsReportList.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.txt_tobecollected.text =  Constants.money_convertor(
            Constants.isEmtytoZero(itemsList[position].getTotalPending()!!), false
        )
    }
