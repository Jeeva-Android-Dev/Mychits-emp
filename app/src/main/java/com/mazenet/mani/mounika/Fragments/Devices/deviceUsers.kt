package com.mazenet.mani.mounika.Fragments.Devices
...
import com.mazenet.mani.mounika.Adapters.DeviceUsersAdapter
import com.mazenet.mani.mounika.Fragments.BaseFragment
import com.mazenet.mani.mounika.Model.BranchModel
import com.mazenet.mani.mounika.Model.DeviceUserListModel
...
class deviceUsers : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(com.mazenet.mani.mounika.R.layout.fragment_devices_users, container, false)
        ...
        showDevicesRecyclerList =
            view.findViewById<RecyclerView>(com.mazenet.mani.mounika.R.id.showUsers) as RecyclerView
        txt_sd_inactivdevices =
            view.findViewById<TextView>(com.mazenet.mani.mounika.R.id.txt_su_inactiveusers) as TextView
        txt_sd_activedevices = view.findViewById<TextView>(com.mazenet.mani.mounika.R.id.txt_su_activeusers) as TextView
        txt_su_totaldevices = view.findViewById<TextView>(com.mazenet.mani.mounika.R.id.txt_su_totaldevices) as TextView
        checkBox_branch = view.findViewById<TextView>(com.mazenet.mani.mounika.R.id.checkBox_su_branch) as CheckBox
        edt_du_search = view.findViewById<EditText>(com.mazenet.mani.mounika.R.id.edt_du_search) as EditText
