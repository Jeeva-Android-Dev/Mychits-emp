...
import com.mazenet.mani.mounika.Model.ComtmntPaymentModel
...
class ComtmntPaymentReportList(
    private val itemsList: ArrayList<ComtmntPaymentModel>,
    private val listener: AdapterClickListener
) : RecyclerView.Adapter<ComtmntPaymentReportList.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.txt_collected.text = Constants.money_convertor(
            Constants.isEmtytoZero(itemsList[position].getDueAmount()!!), false
        )
        holder.txt_tobecollected.text = itemsList[position].getpayment_type_name()!!
    }
