package com.mazenet.mani.mounika.Fragments.Collection
...
import com.mazenet.mani.mounika.Adapters.GroupsAdapter
import com.mazenet.mani.mounika.Fragments.BaseFragment
import com.mazenet.mani.mounika.Model.GroupListModel
import com.mazenet.mani.mounika.Model.GroupdetailsModel
import com.mazenet.mani.mounika.Model.RemarksListmodel
...
import com.mazenet.mani.mounika.Spinners.RemarkSpinnerdilog
import com.mazenet.mani.mounika.Utilities.BaseUtils
import com.mazenet.mani.mounika.Utilities.BaseUtils.masterdb
...
class GroupFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        val view: View
        view = inflater.inflate(com.mazenet.mani.mounika.R.layout.fragment_group, container, false)
        hideProgressDialog()
        (activity as HomeActivity).setActionBarTitle("Generate Receipt")
        Recycler_groups = view.findViewById(com.mazenet.mani.mounika.R.id.Recycler_groups) as RecyclerView
        txt_gf_custname = view.findViewById(com.mazenet.mani.mounika.R.id.txt_gf_custname) as TextView
        enter_remark = view.findViewById(com.mazenet.mani.mounika.R.id.enter_remark) as Button
...
//        Recycler_groups.addItemDecoration(DividerItemDecoration(context, LinearLayoutManager.VERTICAL))
    ...
    fun showremark(con: Activity) {
        ...
        val dialogView = inflater.inflate(com.mazenet.mani.mounika.R.layout.remark_layout, null)
        ...
        var remarkid = ""
        val editText = dialogView.findViewById(com.mazenet.mani.mounika.R.id.edt_remark) as EditText
        val img_folowup = dialogView.findViewById(com.mazenet.mani.mounika.R.id.img_folowup) as ImageButton
        val fab_add_rem =
            dialogView.findViewById(com.mazenet.mani.mounika.R.id.fab_add_rem) as FloatingActionButton
        val btn_submitremark =
            dialogView.findViewById(com.mazenet.mani.mounika.R.id.btn_submitremark) as Button
    ...
    fun add_new_remark_dilog() {
        val dialogBuilder = AlertDialog.Builder(context, com.mazenet.mani.mounika.R.style.MyDialogTheme)

        val inflater = this.layoutInflater
        val dialogView = inflater.inflate(com.mazenet.mani.mounika.R.layout.add_remark_dilog, null)
        dialogBuilder.setView(dialogView)
        val edt_remark =
            dialogView.findViewById(com.mazenet.mani.mounika.R.id.edt_remark) as EditText
